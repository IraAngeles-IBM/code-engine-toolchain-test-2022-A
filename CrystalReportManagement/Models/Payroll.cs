...
namespace CrystalReportManagement.Model
{
     ...
     public class PayrollGenerationResponse
    {
		...
		public decimal	non_taxable_allowance			{ get; set; }
		public decimal	total_deduction_attendance		{ get; set; }
		public decimal	government_contribution			{ get; set; }
		public decimal	ytd_basic						{ get; set; }
		public decimal	ytd_allow_t						{ get; set; }
		public decimal	ytd_allow_nt					{ get; set; }
		public decimal	ytd_ded_att						{ get; set; }
		public decimal	ytd_ded_gov						{ get; set; }
		public decimal	ytd_ded_tax						{ get; set; }
		public decimal	ytd_ded_other					{ get; set; }
		public decimal	ytd_net							{ get; set; }
    ...
    public class PayslipDetaiReport
    {
        public int		posted_payslip_id   { get; set; }
