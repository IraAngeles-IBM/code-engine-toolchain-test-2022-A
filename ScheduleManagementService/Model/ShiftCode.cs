...
namespace ScheduleManagementService.Model
{
    public class ShiftCodeRequest
	{
	...
	public string		series_code					{ get; set; }
	 ...
	 public class ShiftPerDayHeaderResponse
	{
    public string		shift_per_day_id 					{ get; set; }
	public int			int_shift_per_day_id 				{ get; set; }
	public string		shift_per_day_code					{ get; set; }
	public string		shift_name					{ get; set; }
	public int			grace_period				{ get; set; }
	public string		description					{ get; set; }
	public bool			is_flexi					{ get; set; }
	...
	public string		series_code					{ get; set; }
	 ...
	 public class ShiftPerDayDetailResponse
	{
    public string		shift_per_day_id 					{ get; set; }
	public int			int_shift_per_day_id				{ get; set; }
	public string		shift_per_day_code				{ get; set; }
    ...
    public class ShiftCodePerDayHeaderlRequest
	{
    public string		shift_per_day_id			{ get; set; }
	public string		shift_per_day_code			{ get; set; }
	public string		shift_name					{ get; set; }
	...
	public string		series_code					{ get; set; }
		...
		public ShiftCodePerDayDetailRequest[] Detail { get; set; }

	}
	
    public class ShiftCodePerDayDetailRequest
	{
    public string		shift_per_day_id					{ get; set; }
	public string		shift_per_day_code					{ get; set; }
	public string		shift_name					{ get; set; }
