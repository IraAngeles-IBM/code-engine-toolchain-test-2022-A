...
namespace AccountManagementService.Model
{
    ...
    public class CompanyIURequest
    {
        ...
        public string signatory_2_path_old { get; set; }
        ...
        public string signatory_3_path_old { get; set; }
    ...
    public class CompanyResponse
    {
        ...
        public int tk_gen_ref_id { get; set; }
        public string tk_gen_ref { get; set; }
